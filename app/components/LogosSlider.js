...
const LogosSlider = () => {
  return (
    <div className="w-full overflow-hidden">
      ...
      >
        <div className="flex items-center justify-center bg-[#F4F6F5] lg:w-[389.45px] sm:w-[220px] w-[180px] lg:h-[70.39px] sm:h-[50px] h-[45px] rounded-[20px] md:mx-[25px] mx-[10px]">
          <img
