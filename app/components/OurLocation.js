...
const OurLocation = () => {
  return (
    <div className='w-full max-w-[1920px] mx-auto px-5 md:px-10 pt-14' id="location">
      <div className='flex items-center justify-center flex-col gap-2' data-aos="fade-up">
      ...
      <div className='mt-8 w-full max-w-[1770px] mx-auto'>
        <Image src='/assets/location-image.svg' alt='Location' width={1770} height={883}  data-aos="fade-up" />
      </div>

      <div className='my-5 bg-[#396D76] w-full max-w-[1770px] mx-auto text-center px-4 sm:px-8 py-5 rounded-3xl text-white' data-aos="fade-up">
