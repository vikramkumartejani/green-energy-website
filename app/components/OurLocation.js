...
const OurLocation = () => {
  return (
    <div className='w-full max-w-[1920px] mx-auto px-3 md:px-10 pt-14'>
      <div className='flex items-center justify-center flex-col gap-1'>
        ...
        <p className='text-[#4B4B4B] text-[15px] sm:text-[22px] leading-[22px] sm:leading-[27px] text-center font-normal font-inter w-full max-w-[1218px] mx-auto'>Our company strategically operates in Canada, Egypt, and Saudi Arabia, specializing  in LPG, SNG, and MEP systems. Providing comprehensive services from system  design and installation to maintenance and distribution.</p>
      </div>
